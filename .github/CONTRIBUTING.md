...
This document defines the code style rules for all REChain projects, i.e. all projects under https://github.com/REChain-Network-Solutions, not just this repo.
